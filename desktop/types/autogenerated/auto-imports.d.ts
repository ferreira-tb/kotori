...
declare global {
  ...
  const useHeight: (typeof import('manatsu'))['useHeight'];
  ...
  const useWidth: (typeof import('manatsu'))['useWidth'];
  const useWindowFocus: (typeof import('@vueuse/core'))['useWindowFocus'];
  const useWindowHeight: (typeof import('manatsu'))['useWindowHeight'];
  const useWindowScroll: (typeof import('@vueuse/core'))['useWindowScroll'];
  const useWindowSize: (typeof import('@vueuse/core'))['useWindowSize'];
  const useWindowWidth: (typeof import('manatsu'))['useWindowWidth'];
