...
const config = {
    ...
    hooks: {
        generateAssets: async () => {
            ...
            const electronAsar = path.join(__dirname, 'node_modules/electron/dist/resources/electron.asar');
            if (!exists(electronAsar)) {
                const src = path.join(__dirname, 'node_modules/@sequelize/core/node_modules/bnf-parser');
